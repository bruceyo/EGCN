...
results_save = np.zeros([10, 2])
for index, eval_criteria in enumerate(['cv_cs']):#'cv_cs','cv_rd'
    label_path = '/media/bruce/2T/data/UI_PRMD/st-gcn/'+ eval_criteria +'/xyz'

    result_path_xyz = '/media/bruce/2T/data/UI_PRMD/work_st_gcn/kinect/'+ eval_criteria +'/xyz'
    result_path_ang = '/media/bruce/2T/data/UI_PRMD/work_st_gcn/kinect/'+ eval_criteria +'/ang'
