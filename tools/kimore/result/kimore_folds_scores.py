...
for index, method in enumerate(['mul']):#  'xyz','ang','xyzang','cat','add','lit','mul'
    ...
    for action in actions:
        ...
        np.savetxt('/media/bruce/2T/data/KiMoRe/work_st_gcn/kinect/scores_rd/'+ method +'_' + str(action) + '.csv', results_score, fmt='%s', delimiter=",", header="Index, A1, A2")
